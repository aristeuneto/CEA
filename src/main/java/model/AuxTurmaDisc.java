...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "AuxTurmaDisc.findAll", query = "SELECT a FROM AuxTurmaDisc a")
    , @NamedQuery(name = "AuxTurmaDisc.findByAuxId", query = "SELECT a FROM AuxTurmaDisc a WHERE a.auxId = :auxId")})
public class AuxTurmaDisc implements Serializable {
    ...
    public AuxTurmaDisc(Integer auxId) {
        this.auxId = auxId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AuxTurmaDisc)) {
            return false;
        }
        AuxTurmaDisc other = (AuxTurmaDisc) object;
    ...
    public String toString() {
        return "model.AuxTurmaDisc[ auxId=" + auxId + " ]";
    }
