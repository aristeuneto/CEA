...
@NamedQueries({
    ...
    , @NamedQuery(name = "Matricula.findByMatAnoLetivo", query = "SELECT m FROM Matricula m WHERE m.matAnoLetivo = :matAnoLetivo")
    , @NamedQuery(name = "Matricula.findByMatTurno", query = "SELECT m FROM Matricula m WHERE m.matTurno = :matTurno")
    , @NamedQuery(name = "Matricula.findByMatSerie", query = "SELECT m FROM Matricula m WHERE m.matSerie = :matSerie")
    , @NamedQuery(name = "Matricula.findByMatData", query = "SELECT m FROM Matricula m WHERE m.matData = :matData")
    , @NamedQuery(name = "Matricula.findByMatStatus", query = "SELECT m FROM Matricula m WHERE m.matStatus = :matStatus")})
public class Matricula implements Serializable {
    ...
    public Matricula(Integer matId) {
        this.matId = matId;
    }

    public Matricula(Integer matId, String matAnoLetivo, String matTurno, String matSerie, String matStatus) {
        this.matId = matId;
    ...
    public String toString() {
        return "model.Matricula[ matId=" + matId + " ]";
    }
